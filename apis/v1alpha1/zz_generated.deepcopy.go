...
func (in *ConfigurationPlaybook) DeepCopyInto(out *ConfigurationPlaybook) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigurationPlaybook.
func (in *ConfigurationPlaybook) DeepCopy() *ConfigurationPlaybook {
	if in == nil {
		return nil
	}
	out := new(ConfigurationPlaybook)
	in.DeepCopyInto(out)
	return out
}
